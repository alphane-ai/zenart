...
const localAlphaWebBaseURL = process.env.WEB_PLAYWRIGHT_BASE_URL ?? "http://127.0.0.1:26080";
const localAlphaWebServerContract =
  "web/playwright.config.ts webServer starts npm run dev -- --hostname 127.0.0.1 --port 26080";
...
const commonEvidence = (baseURL: string | undefined) => ({
  ...
  local_stack: {
    web_base_url: baseURL ?? localAlphaWebBaseURL,
    web_server_contract: localAlphaWebServerContract,
