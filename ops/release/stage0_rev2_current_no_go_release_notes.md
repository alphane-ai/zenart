...
- Production Launch gate: `no_go` from `fixtures/stage0/rev2/release_gate_evidence.production_launch.json`; blocked checks: production_backup_rollback_incident; active do-not-launch conditions: backup_restore_rollback_smoke_missing, production_deploy_rollback_smoke_missing, ci_staging_gates_not_passed; decision evidence: fixtures/stage0/rev2/release_gate_evidence.production_launch.json gate_decision.status=no_go for checklist item Production Launch runtime/deployment evidence 通过：provider-or-comp-only、paid lifecycle、skill canary、activation audit、abuse hold、security、backup/rollback/post-deploy smoke、legal/support policy 均有 production evidence。 while production_backup_rollback_incident is blocked and backup_restore_rollback_smoke_missing, production_deploy_rollback_smoke_missing, and ci_staging_gates_not_passed remain active; ops/evidence/production/provider-mode.json plus ops/evidence/production/public-paid-real-generation-claims.json clear provider mode, ops/evidence/production/billing-lifecycle.json plus ops/evidence/production/billing-refund-credit-webhook.json clear paid billing lifecycle, and ops/evidence/production/20260527T1800Z-backup-rollback-incident-smoke.json is admin-visible operations evidence but cannot close the backup check before upstream gates pass; exact production backup/restore evidence ops/evidence/production/backup-restore.json is absent; exact production rollback/incident/post-deploy smoke evidence ops/evidence/production/rollback-incident-post-deploy-smoke.json is absent; upstream CI fixture fixtures/stage0/rev2/release_gate_evidence.ci.json is present with gate_decision.status=no_go; upstream Private Beta/Staging fixture fixtures/stage0/rev2/release_gate_evidence.private_beta_staging.json is present with gate_decision.status=no_go
