...
The executable workflow draft is `ops/ci/stage0-rev2-ci.yml`. It is installed under `.github/workflows/stage0-rev2-ci.yml`; the installed copy must stay byte-for-byte aligned with the ops draft until PR/main runtime evidence closes the CI gate.

## Open Checklist

- [x] Install `ops/ci/stage0-rev2-ci.yml` as `.github/workflows/stage0-rev2-ci.yml`.
...
Deferred runtime gates are tracked in `ops/evidence/stage0_environment_evidence.json` instead of being marked complete in the blueprint.
