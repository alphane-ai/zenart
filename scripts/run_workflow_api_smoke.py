...
def execute_step(base_url: str, step: dict[str, Any], workflow: dict[str, Any], context: dict[str, str]) -> tuple[str, Any]:
...
def run_workflow(workflow: dict[str, Any], base_url: str, live: bool) -> dict[str, Any]:
    ...
    for step in workflow["api_smoke_contract"]["request_sequence"]:
        ...
        if live and stop_reason:
            ...
            actual_status, response_body = execute_step(base_url, step, workflow, context)
