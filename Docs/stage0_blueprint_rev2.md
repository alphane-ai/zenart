...
- Validator-owned non-closure probe files, including `ops/evidence/staging/object-storage-retention-cleanup.blocked.json` and `ops/evidence/production/20260527T1800Z-backup-rollback-incident-smoke.json`, may appear only in their explicit blocked check、active Do-Not-Launch、or no-go gate-decision contexts; they are invalid as cleared-condition evidence, passing-check evidence, aggregate `go` evidence, Production Launch evidence, or global Do-Not-Launch closure evidence.
